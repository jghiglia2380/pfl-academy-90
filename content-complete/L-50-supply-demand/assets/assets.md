# Asset Specifications for L-50-supply-demand: Supply and Demand in Personal Finance
...
### 1. Market Analyzer Tool (PRIMARY INTERACTIVE TOOL)
**File:** `Market_Analyzer_Tool.html`
**Purpose:** Analyze supply and demand factors affecting personal financial decisions
...
STATE_MEDIAN_HOME_PRICE, STATE_MEDIAN_RENT, STATE_UNEMPLOYMENT_RATE

## 55-Minute Class Flow

**Chapter Resource Usage Suggestions:**
- 0-5 min: Distribute Reference Sheet
- 5-25 min: Direct instruction
- 25-45 min: Market Analyzer Tool (interactive activity - pairs)
- 45-55 min: Debrief and wrap-up

**Additional Activities:**
- 0-10 min: Review and setup
- 10-35 min: Supporting activities (individual)
- 35-50 min: Reflection and discussion
- 50-55 min: Wrap-up
